...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stationnamebox.setGeometry(QtCore.QRect(190, 10, 133, 20))
        ...
        self.tiplocbox.setGeometry(QtCore.QRect(190, 40, 81, 20))
        ...
        self.label_5.setGeometry(QtCore.QRect(40, 70, 91, 16))
        self.label_5.setObjectName("label_5")
        self.mintimebox = QtWidgets.QLineEdit(self.frame)
        self.mintimebox.setGeometry(QtCore.QRect(140, 70, 71, 20))
        self.mintimebox.setObjectName("mintimebox")
        self.label_6 = QtWidgets.QLabel(self.frame)
        self.label_6.setGeometry(QtCore.QRect(220, 70, 21, 16))
        self.label_6.setObjectName("label_6")
        self.maxtimebox = QtWidgets.QLineEdit(self.frame)
        self.maxtimebox.setGeometry(QtCore.QRect(250, 70, 71, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Made (Number)"))
        ...
        self.label_3.setText(_translate("MainWindow", "Find all connections at station name"))
        self.label_4.setText(_translate("MainWindow", "that has TIPLOC code"))
        self.pushButton_3.setText(_translate("MainWindow", "Generate connections"))
        ...
        self.udselector.setItemText(0, _translate("MainWindow", "ScotRail"))
